...
public class NotificationCenter
{
	...
	public void AddObserver (Handler handler, string notificationName, System.Object sender)
	{
		if (handler == null)
		{
			System.Console.WriteLine("Can't add a null event handler for notification, " + notificationName);
			return;
		}
		
		if (string.IsNullOrEmpty(notificationName))
		{
			System.Console.WriteLine("Can't observe an unnamed notification");
			return;
		}
	...
	public void RemoveObserver (Handler handler, string notificationName, System.Object sender)
	{
		if (handler == null)
		{
			System.Console.WriteLine("Can't remove a null event handler for notification, " + notificationName);
			return;
		}
		
		if (string.IsNullOrEmpty(notificationName))
		{
			System.Console.WriteLine("A notification name is required to stop observation");
			return;
		}
	...
	public void PostNotification (string notificationName, System.Object sender, System.Object e)
	{
		if (string.IsNullOrEmpty(notificationName))
		{
			System.Console.WriteLine("A notification name is required");
			return;
		}
