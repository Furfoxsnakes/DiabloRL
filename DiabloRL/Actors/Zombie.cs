...
namespace DiabloRL.Actors
{
    public class Zombie : Monster
    {
        ...
        public Zombie(Coord position) : base(Color.DarkKhaki, Color.Black, 'Z', name: "Zombie", position)
        {
            ...
            var data = GetDataFromJson("Zombie");
        ...
        private void GenerateJsonFile()
        {
            var monsterData = new MonsterData()
            {
                ...
                MagicResistance = new Dictionary<Difficulties, ResistanceTypes>()
                {
                ...
                FireResistance = new Dictionary<Difficulties, ResistanceTypes>()
                {
                    {Difficulties.NORMAL, ResistanceTypes.NONE},
                    {Difficulties.NIGHTMARE, ResistanceTypes.NONE},
                    {Difficulties.HELL, ResistanceTypes.NONE}
                },
                LightningResistance = new Dictionary<Difficulties, ResistanceTypes>()
                {
                    {Difficulties.NORMAL, ResistanceTypes.NONE},
                    {Difficulties.NIGHTMARE, ResistanceTypes.NONE},
                    {Difficulties.HELL, ResistanceTypes.NONE}
